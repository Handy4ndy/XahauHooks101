...
//
// Description:
//   Emits native XAH payments to up to 3 user-defined accounts and amounts, set via invoke parameters. Only emits when the incoming XAH payment matches the exact amount set by invoke parameter.
//
// Triggers:
