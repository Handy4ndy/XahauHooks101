//**************************************************************
// Xahau Hook 101 Example ~ Basic State Count Decrease Hook
// Author: @handy_4ndy
//
// Description:
...
int64_t hook(uint32_t reserved) {
    ...
    TRACESTR("BasicStateCounterDecrease: called");
    ...
    // Retrieve current count from state, default to 100 if not set
    uint8_t count_buf[8];
    ...
    if (count <= 0) {
        NOPE("Error: Counter reached 0, execution limit reached");
    }
