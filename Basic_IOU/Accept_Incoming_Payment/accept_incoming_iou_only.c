//**************************************************************
// Xahau Hook 101 Example ~ Accept Incoming IOU Only
// Author: @Handy_4ndy
//
// Description:
//   Accepts only incoming IOU payments; rejects outgoing payments and incoming XAH payments.
//
// Triggers:
...
//   - Only incoming IOU payments will be accepted.
//
// Accepts:
