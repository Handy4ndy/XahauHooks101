...
//
// Description:
//   This hook accepts incoming XAH payments that match the specified amount (10 XAH), outgoing payments, and incoming IOU payments.
//   Rejects incoming XAH payments that do not match the exact amount.
//
// Accepts:-
