...
//
// Description:
//   Accepts incoming XAH payments and outgoing payments. Rejects incoming IOU payments.
//
// Triggers:
...
//   - Incoming XAH payments and outgoing payments are accepted; incoming IOU payments are rejected.
//
// Accepts:
